...
public class HFrom {
   ...
   public HFrom(HQueryInfo query, Class<?> entityClass) {
      this.query = query;
      this.query.from = entityClass.getName();
   }

   public HFrom(HQueryInfo query, String name) {
      this.query = query;
      this.query.from = name;
   }

   public HFromAs as(String as) {
      return new HFromAs(this.query, as);
   }
